...
const WorkspaceSidebar = ({
  ...
  return (
    <>
          ...
          <ul>
            {WORKSPACE_SIDEBAR.boards.map(
              ({ backgroundGradient, isFavorite, title, workspace }, i) => (
                ...
                >
                  <Link href="/" className="flex items-center gap-x-4 text-sm">
                    <div
      ...
      >
        <button className="transform click-link p-1 bg-gray-300 rounded-full absolute top-16 left-1 group-hover:bg-gray-400">
