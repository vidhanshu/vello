  ...
  return (
    <div className="p-4">
      ...
      <div className="border-b py-4">
        <h1 className="text-lg font-bold">Invite members to join you</h1>
      ...
      <div className="py-4">
        ...
        <div>
          {MEMBERS.filter((item) => item.role === "workspace_member").map(
            (item) => (
              <MembersListItemWithActions key={item.email} {...item} />
            )
          )}
        </div>
      </div>
