...
const VelloInAction = () => {
    ...
    return (
        <section className="bg-white py-16">
            ...
            >
                {VELLO_IN_ACTION_CAROUSEL.map(
                    ({ color, description, title, Icon }) => (
            ...
            <div className="max-w-screen-xlg m-auto px-4 flex flex-col gap-6 items-center pt-8 md:flex-row">
                <p className="text-xl">
                    No need to start from scratch. Jump-start your workflow with
                    a proven playbook designed for different teams. Customize it
                    to make it yours.
                </p>
                <Button variant="sec" size="primary">
