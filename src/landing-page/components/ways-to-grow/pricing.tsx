        ...
        <div className="pb-20 pt-10">
            <div className="space-y-4">
                ...
                <p className="text-center max-w-2xl m-auto text-xl">
                    Trusted by millions, Trello powers teams all around the
                    world.
                </p>
                <Button
    ...
    return (
        <div
            className={cn(
                ...
                name === 'PREMIUM'
                    ? 'border-sec border-[2px]'
                    : 'border-[1px] md:border-r-0'
            )}
        >
            ...
            <p className="font-medium text-base min-h-12 md:h-48 pb-4">
                {description}
            </p>
            <Link href={link}>
                <Button
